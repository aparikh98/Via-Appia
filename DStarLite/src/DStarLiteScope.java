...
public class DStarLiteScope implements java.io.Serializable {
	...
	private static final double maxVisionRange = 2; //note: min slightly more than sqrt2
	...
	static class Surface extends JPanel{
		...
		public void paintComponent(Graphics g){
			...
			for(int i = 0; i < traveledList.size(); i++){
				paintRect(g, traveledList.get(i).x*width,traveledList.get(i).y*height, width, height, Color.BLUE);
